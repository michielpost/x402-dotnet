...
namespace x402
{
    ...
    public class PaymentMiddleware
    {
        ...
        public async Task InvokeAsync(HttpContext context)
        {
            ...
            var x402Result = await x402Handler.HandleX402Async(paymentConfig.PaymentRequirements, paymentConfig.PaymentRequirements.Discoverable, paymentMiddlewareOptions.SettlementMode).ConfigureAwait(false);
